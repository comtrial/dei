...
- 로컬 개발은 익명 Supabase 세션과 개발자 전용 본인확인 완료 버튼으로 빠르게 흐름을 확인합니다.
- 현재 인증 개발 범위는 PortOne 본인 명의 확인 중심입니다.
- PortOne은 성인 인증이 아니라 본인 명의 휴대폰 확인 용도로 사용합니다.
- 성인 인증은 이번 범위에서 제외합니다.
...
- 범위 문서: `docs/portone-auth-scope.md`
