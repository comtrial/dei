...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      _ensure_side_team: {
        Args: { p_gender: string; p_user_ids: string[] }
        Returns: string
      }
      _match_boost: { Args: { p_enqueued_at: string }; Returns: string }
      _tier_of: { Args: { p_waited_minutes: number }; Returns: number }
      _try_solo_merge: {
        Args: {
          p_gender: string
          p_req: string
      ...
      expire_my_stale_queue: { Args: never; Returns: number }
      get_room_videos: {
      ...
      match_and_create: {
        Args: {
          ...
          p_side_b_gender: string
          p_side_b_user_ids: string[]
        }
        Returns: string
      }
      match_cfg_int: {
