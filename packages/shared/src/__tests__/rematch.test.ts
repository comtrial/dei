...
describe('rematch restriction', () => {
  it('방 이탈 24시간 안이면 제한 상태와 가능 시각을 반환한다', () => {
    ...
    expect(restriction.availableAt).toBe('2026-05-31T00:00:00.000Z');
    expect(formatRematchCountdown(restriction.remainingMs)).toBe('23:32');
  });
