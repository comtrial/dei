...
/**
 * S13a `.input-bar` 컨테이너 — paper 표면 / 상단 라인 / gap 8 / 패딩 10·14·14.
 * (border-top 1px var(--line) → `border-t border-line`)
 */
const BAR_CLASS =
  'flex-row items-center gap-[8px] border-t border-line bg-paper px-[14px] pt-[10px] pb-[14px]';
...
export const InputBar = forwardRef<View, InputBarProps>(function InputBar(
  ...
  return (
    <View ref={ref} className={cn(BAR_CLASS, className)} {...rest}>
