...
export const TERMS_DOCUMENTS: Record<TermsDocumentId, TermsDocument> = {
  ...
  location: {
    ...
    title: '위치정보 이용약관',
    required: false,
    summary: '위치기반 서비스 이용 조건과 개인위치정보 처리 기준을 안내합니다.',
    updatedAt: '2026.06.01',
    blocks: [
      {
        heading: '제1조 (목적)',
        paragraphs: [
          '본 약관은 커맨드소프트웨어(이하 "회사")가 제공하는 사물위치정보 및 위치기반 서비스(이하 "위치정보 서비스")에 대해 회사와 서비스를 이용하는 이용자 간의 권리·의무 및 책임사항, 기타 필요한 사항 규정을 목적으로 합니다.',
        ],
      },
      {
        heading: '제2조 (이용약관의 효력 및 변경)',
        paragraphs: [
          ...
          '④ 약관이 변경되는 경우 회사는 변경사항을 그 적용일자 최소 15일 전에 회사의 홈페이지 또는 서비스 공지사항 등(이하 "홈페이지 등")을 통해 공지합니다. 다만, 개정되는 내용이 이용자 권리의 중대한 변경을 발생시키는 경우 적용일 최소 30일 전에 이메일(이메일주소가 없는 경우 서비스 내 전자쪽지 발송, 서비스 내 알림 메시지를 띄우는 등의 별도의 전자적 수단) 발송 또는 등록한 휴대폰번호로 앱 내 알림(푸시) 또는 문자메시지를 발송하는 방법 등으로 개별적으로 고지합니다.',
      ...
      },
      {
        heading: '제3조 (약관 외 준칙)',
        paragraphs: [
          '이 약관에 명시되지 않은 사항에 대해서는 위치정보의 보호 및 이용 등에 관한 법률, 개인정보보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관계법령 및 회사가 정한 지침 등의 규정에 따릅니다.',
        ],
      },
      {
        heading: '제4조 (서비스의 내용)',
        paragraphs: [
          ...
          '① 위치 기반 매칭·추천 : 이용자의 위치나 지역을 바탕으로 매칭 상대 또는 관련 정보·콘텐츠를 추천해주는 서비스를 제공합니다.',
          '② 위치 기반 콘텐츠 분류(Geo Tagging) : 이용자가 작성·업로드한 게시글, 사진, 영상 등에 위치정보를 저장하거나, 위치를 기반으로 콘텐츠를 분류하는 기능을 제공합니다.',
          '③ 위치 기반 소셜 서비스 제공 : 내 위치를 다른 이용자와 공유하거나 콘텐츠 남기기 등 인터랙션을 포함한 위치 서비스를 제공합니다.',
          '④ 위치 기반 광고 : 이용자의 위치정보를 활용한 광고성 정보 안내, 검색 및 디스플레이 광고소재 제공, 맞춤형 광고를 제공합니다.',
        ],
      },
      {
        heading: '제5조 (서비스 이용요금)',
        paragraphs: [
          '회사가 제공하는 위치정보 서비스는 무료입니다. 단, 무선 서비스 이용 시 발생하는 데이터 통신료는 별도이며, 이용자가 가입한 각 이동통신사의 정책에 따릅니다.',
        ],
      },
      {
        heading: '제6조 (서비스의 변경·제한·중지)',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '④ 위 1, 2, 3항에도 불구하고 다른 법령 또는 위치정보법에 따라 보유해야 하는 정당한 사유가 있는 경우에는 그에 따릅니다.',
        ],
      },
      {
        heading: '제10조 (개인위치정보주체의 권리)',
        paragraphs: [
          ...
          '⑤ 이용자는 권리행사를 위해 본 약관 제16조의 연락처를 이용하여 회사에 요청할 수 있습니다.',
        ],
      },
      {
        heading: '제11조 (법정대리인의 권리)',
        paragraphs: [
          ...
          '② 회사는 14세 미만 아동의 개인위치정보 또는 위치정보 이용·제공사실 확인자료를 이용약관에 명시 또는 고지한 범위를 넘어 이용하거나 제3자에게 제공하고자 하는 경우 이용자와 이용자의 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는 제외합니다.',
          '위치정보 및 위치기반서비스 제공에 따른 요금정산을 위하여 위치정보 이용·제공사실 확인자료가 필요한 경우',
          '통계작성, 학술연구 또는 시장조사를 위하여 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우',
        ],
      },
      {
        heading: '제12조 (8세 이하의 아동 등의 보호의무자의 권리)',
        paragraphs: [
          '① 회사는 아래의 경우에 해당하는 자(이하 "8세 이하의 아동 등")의 위치정보의 보호 및 이용 등에 관한 법률 제26조 제2항에 해당하는 자(이하 "보호의무자")가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.',
          '8세 이하의 아동',
          '피성년후견인',
          ...
          '③ 보호의무자는 8세 이하의 아동 등의 개인위치정보 이용 또는 제공에 동의하는 경우 본 약관 제10조에 의한 이용자의 권리를 모두 가집니다.',
        ],
      },
      {
        heading: '제13조 (손해배상)',
        paragraphs: [
          '회사의 위치정보의 보호 및 이용 등에 관한 법률 제15조 및 제26조의 규정을 위반한 행위로 인해 손해를 입은 경우 이용자는 회사에 손해배상을 청구할 수 있습니다. 회사는 고의·과실이 없음을 입증하지 못하는 경우 책임을 면할 수 없습니다.',
        ],
      },
      {
        heading: '제14조 (면책)',
      ...
      {
        heading: '제16조 (사업자 및 위치정보관리책임자 정보)',
        paragraphs: [
