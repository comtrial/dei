...
begin
  ...
  if nullif(trim(p_gender), '') is null then
...
update public.account_status
set onboarding_state = 'log_intro'::public.onboarding_state
where onboarding_state = 'first_video'
  and profile_completed_at is not null
  and first_video_uploaded_at is null;
